...
RSpec.describe Post, type: :model do
  ...
  let(:user) { User.create!(name: Random_Data.random_name, email: Random_Data.random_email, password: "helloworld", role: :member) }
  ...
  describe "voting" do
    ...
    describe "#create_vote" do
      ...
      it "calls #create_vote when a post is created" do
        post = topic.posts.new(title: Random_Data.random_sentence, body: Random_Data.random_paragraph, user: user)
