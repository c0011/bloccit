...
RSpec.describe TopicsController, type: :controller do
  ...
  context "guest" do
    ...
    describe "POST create" do
      it "returns http redirect" do
        post :create, topic: {name: Random_Data.random_sentence, description: Random_Data.random_paragraph}
        expect(response).to redirect_to(new_session_path)
      end
    end
    ...
    describe "PUT update" do
      it "returns http redirect" do
        new_name = Random_Data.random_sentence
        new_description = Random_Data.random_paragraph
  ...
  context "admin user" do
    ...
    describe "POST create" do
      it "increases the number of topics by 1" do
        expect{ post :create, topic: {name: Random_Data.random_sentence, description: Random_Data.random_paragraph} }.to change(Topic,:count).by(1)
      end
